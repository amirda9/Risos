...
export class ResizeComponent implements OnInit {
  ...
  private resize(){
    if(this.resizeCondMeet()){
      this.width = (this.mouse.x > this.boxPosition.left) ? this.mouse.x - this.boxPosition.left : 0;
      this.height = (this.mouse.y > this.boxPosition.top) ? this.mouse.y - this.boxPosition.top : 0;
    }
  }
